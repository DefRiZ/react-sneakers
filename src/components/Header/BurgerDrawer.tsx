...
const BurgerDrawer: React.FC = () => {
  ...
  const onClickOrder = () => {
    ...
    dispatch(changeBurgerDrawer());
  };

  return (
    <div className={styles.overlay}>
      <div className={styles.blockLeft}>
        <button onClick={() => onClickOrder()} className={styles.cart}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 20 20"
        ...
        <button>
          <Link to="/favorite" onClick={() => dispatch(changeBurgerDrawer())}>
            <svg
        ...
        <button>
          <Link to="/orders" onClick={() => dispatch(changeBurgerDrawer())}>
            <svg
